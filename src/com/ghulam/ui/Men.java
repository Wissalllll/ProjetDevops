...
public class Men implements UICategory {
	...
	public void category() {
		String categories[] = { "T-Shirts", "Chemises", "Costumes & Blazers" };
		...
		case 1:
			...
			break;
		case 2:
			UI.printSubCategory(productBO.getShirts(), "Chemises");
			break;
		case 3:
			UI.printSubCategory(productBO.getSuits(), "Costumes & Blazers");
			break;
		}
	}
}
